...
VPATH=./src/:./examples
SLIB_NAME=./libdarknet.so
ALIB_NAME=./libdarknet.a
EXEC_NAME=darknet
OBJDIR=./obj/
LIBDIR=./lib/

CC=gcc
#Give the path of NVCC installation  NVCC=nvcc
...
SLIB=$(LIBDIR)/$(SLIB_NAME)
ALIB=$(LIBDIR)/$(ALIB_NAME)
EXEC=$(LIBDIR)/$(EXEC_NAME)
